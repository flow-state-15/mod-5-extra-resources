  ...
  render(){
    ...
    (<>
      ...
      <input
        ...
        onChange={() => this.setState(state => ({ inputValue: e.target.value }), this.optionalCallbackAfterSliceUpdates)}
        />
    </>)
  }
}
...
export default class App extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState){
    ...
    if(prevState.count !== this.state.count){
      console.log('count state was changed, latest data:: ', this.state.count, 'oldState:: ', prevState)
    }
